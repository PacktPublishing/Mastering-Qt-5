...
void AlbumWidget::setPictureModel(PictureModel* pictureModel)
{
    ...
    mThumbnailModel.setSourceModel(mPictureModel);
    ui->thumbnailListView->setModel(&mThumbnailModel);
}
...
void AlbumWidget::addPictures()
{
    ...
    if (!filenames.isEmpty()) {
        ...
        for (auto filename : filenames) {
            ...
            lastModelIndex = mPictureModel->addPicture(picture);
        }
...
{
    mPictureModel->setAlbumId(mAlbumModel->data(albumIndex, AlbumModel::Roles::IdRole).toInt());
